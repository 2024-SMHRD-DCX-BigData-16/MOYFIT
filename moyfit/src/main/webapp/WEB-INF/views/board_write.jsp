...
<body>
	...
	<div class="write-container">
		<h2>글쓰기</h2>
		<form action="board_insert" class="write-form" method="post" enctype="multipart/form-data">
			...
			<div>
				<label for="title">제목</label> <input type="text" id="title"
					name="b_title" required placeholder="제목을 입력해주세요" style="width: 600px; height: 30px;">
			</div>
			...
			<div style="text-align: center;">
			    <form action="board" method="post" style="display: flex; justify-content: center; gap: 10px;">
			        <input type="submit" class="submit-btn" value="등록" 
			               style="width: 250px; height: 50px; background-color: #5882FA; border: none; cursor: pointer; font-size: 16px;">
